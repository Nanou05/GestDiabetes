# -*- coding: utf-8 -*-
"""
Created on Mar  5 10:35:09 2024
...
contractions_dict = {
    ...
    "what've": "what have", "when've": "when have", "where'd": "where did", "where've": "where have", "who'll": "who will", "who'll've": "who will have",
    "who've": "who have", "why've": "why have", "will've": "will have", "won't": "will not", "won't've": "will not have", "would've": "would have",
    ...
    "you'll've": "you will have", "you're": "you are", "you've": "you have", "gd": "gestational diabetes"
}

with open('contractions.json', 'w') as json_file:
